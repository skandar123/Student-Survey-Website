...
<!-- If mean>=90, the servlet requests this page using RequestDispatcher object, thanks the user, announces that the user is a raffle winner of 2 movie tickets and prints the mean and standard deviation accessing data from DataBean. -->
...
<h1>Winner Acknowledgement Page</h1>
</head>
<body>
	<div class="relative">
	<h3>Thank you for completing the Survey form.</h3>
	<h3>Congratulations! You are the winner of two movie tickets!</h3>
